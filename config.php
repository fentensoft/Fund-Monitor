<?php
    ...
    class FundConfig {
    	var $FUNDA = array("Name"=>"分级基金", "URL"=>"http://www.jisilu.cn/data/sfnew/funda_list/", "Key"=>"funda_base_est_dis_rt", "Threshold"=>"cfg_fundathre", "VolumeKey"=>"funda_volume");
    	var $QDII = array("Name"=>"QDII基金", "URL"=>"http://www.jisilu.cn/data/qdii/qdii_list/", "Key"=>"discount_rt", "Threshold"=>"cfg_qdiithre", "VolumeKey"=>"volume");
    	var $db, $kv;
